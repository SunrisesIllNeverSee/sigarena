...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/vs/claudecount" },
  openGraph: {
    title: "SigRank vs claudecount — Token Counting vs Cascade Scoring",
    description: "Token counting vs cascade scoring",
    url: "https://sigeconomy.com/vs/claudecount",
    type: "website",
  },
};

export default function VsuclaudecountPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs claudecount — Token Counting vs Cascade Scoring", "claudecount counts Claude Code tokens. SigRank scores cascades. Counting is not scoring.", "/vs/claudecount"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/claudecount" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and claudecount?", answer: "claudecount counts Claude Code tokens. SigRank scores cascades. Counting is not scoring. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both claudecount and SigRank?", answer: "Yes. They're complementary. Use claudecount for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs claudecount — Token Counting vs Cascade Scoring</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Token counting vs cascade scoring</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">claudecount</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">Claude Code token counts</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">How many tokens you burned</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>claudecount counts Claude Code tokens. SigRank scores cascades. Counting is not scoring.</p>
        <p>
          ...
          the question claudecount can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and claudecount?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Can I use both claudecount and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop counting. Start scoring.</p>
        <a
