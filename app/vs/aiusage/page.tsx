...
export const metadata: Metadata = {
  title: "SigRank vs aiusage — Usage Tracking vs Efficiency Scoring",
  description:
    "aiusage tracks AI usage stats. SigRank scores cascade yield. Usage tracking is accounting; yield scoring is evaluation.",
  alternates: { canonical: "/vs/aiusage" },
  openGraph: {
    title: "SigRank vs aiusage — Usage Tracking vs Efficiency Scoring",
    description: "Usage tracking vs yield scoring",
    url: "https://sigeconomy.com/vs/aiusage",
    type: "website",
  },
};

export default function VsuaiusagePage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs aiusage — Usage Tracking vs Efficiency Scoring", "aiusage tracks AI usage stats. SigRank scores cascade yield. Usage tracking is accounting; yield scoring is evaluation.", "/vs/aiusage"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/aiusage" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and aiusage?", answer: "aiusage tracks AI usage stats. SigRank scores cascade yield. Usage tracking is accounting; yield scoring is evaluation. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both aiusage and SigRank?", answer: "Yes. They're complementary. Use aiusage for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs aiusage — Usage Tracking vs Efficiency Scoring</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Usage tracking vs yield scoring</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">aiusage</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">AI usage stats (volume)</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">How much you used</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>aiusage tracks AI usage stats. SigRank scores cascade yield. Usage tracking is accounting; yield scoring is evaluation.</p>
        <p>
          ...
          the question aiusage can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and aiusage?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              aiusage tracks AI usage stats. SigRank scores cascade yield. Usage tracking is accounting; yield scoring is evaluation. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both aiusage and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use aiusage for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop tracking usage. Start scoring yield.</p>
        <a
