...
export const metadata: Metadata = {
  title: "SigRank vs vibe-island — Vibe Coding vs Yield Coding",
  description:
    "vibe-island is a vibe coding platform. SigRank scores the yield of your coding sessions. Vibes are feelings; yield is measurement.",
  alternates: { canonical: "/vs/vibe-island" },
  openGraph: {
    title: "SigRank vs vibe-island — Vibe Coding vs Yield Coding",
    description: "Vibe coding vs yield coding",
    url: "https://sigeconomy.com/vs/vibe-island",
    type: "website",
  },
};

export default function VsuvibeislandPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs vibe-island — Vibe Coding vs Yield Coding", "vibe-island is a vibe coding platform. SigRank scores the yield of your coding sessions. Vibes are feelings; yield is measurement.", "/vs/vibe-island"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/vibe-island" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and vibe-island?", answer: "vibe-island is a vibe coding platform. SigRank scores the yield of your coding sessions. Vibes are feelings; yield is measurement. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both vibe-island and SigRank?", answer: "Yes. They're complementary. Use vibe-island for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs vibe-island — Vibe Coding vs Yield Coding</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Vibe coding vs yield coding</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">vibe-island</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              <td className="px-4 py-3 font-semibold">What it measures</td>
              <td className="px-4 py-3 text-muted-foreground">Operator yield scoring</td>
              <td className="px-4 py-3 text-muted-foreground">Vibe coding platform</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">How the vibes felt</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>vibe-island is a vibe coding platform. SigRank scores the yield of your coding sessions. Vibes are feelings; yield is measurement.</p>
        <p>
          ...
          the question vibe-island can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and vibe-island?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              vibe-island is a vibe coding platform. SigRank scores the yield of your coding sessions. Vibes are feelings; yield is measurement. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both vibe-island and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use vibe-island for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop vibing. Start yielding.</p>
        <a
