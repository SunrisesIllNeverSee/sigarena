...
export const metadata: Metadata = {
  title: "SigRank vs opcode — CLI vs Operator Score",
  description:
    "opcode is an AI coding CLI. SigRank scores the operator using any CLI. The tool isn't the skill; the yield is.",
  alternates: { canonical: "/vs/opcode" },
  openGraph: {
    title: "SigRank vs opcode — CLI vs Operator Score",
    description: "The CLI vs the operator score",
    url: "https://sigeconomy.com/vs/opcode",
    type: "website",
  },
};

export default function VsuopcodePage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs opcode — CLI vs Operator Score", "opcode is an AI coding CLI. SigRank scores the operator using any CLI. The tool isn't the skill; the yield is.", "/vs/opcode"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/opcode" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and opcode?", answer: "opcode is an AI coding CLI. SigRank scores the operator using any CLI. The tool isn't the skill; the yield is. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both opcode and SigRank?", answer: "Yes. They're complementary. Use opcode for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs opcode — CLI vs Operator Score</span>
        </h1>
        <p className="mt-2 text-muted-foreground">The CLI vs the operator score</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">opcode</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">AI coding CLI</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">What the CLI executed</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>opcode is an AI coding CLI. SigRank scores the operator using any CLI. The tool isn't the skill; the yield is.</p>
        <p>
          ...
          the question opcode can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and opcode?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              opcode is an AI coding CLI. SigRank scores the operator using any CLI. The tool isn't the skill; the yield is. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both opcode and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use opcode for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop measuring the CLI. Start scoring the operator.</p>
        <a
