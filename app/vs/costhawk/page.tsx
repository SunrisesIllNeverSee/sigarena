    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and CostHawk?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Does SigRank compete with CostHawk?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
