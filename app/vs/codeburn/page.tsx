...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/vs/codeburn" },
  openGraph: {
    title: "SigRank vs codeburn — Cost Tracking vs Efficiency Scoring",
    description: "Cost tracking vs efficiency scoring",
    url: "https://sigeconomy.com/vs/codeburn",
    type: "website",
  },
};

export default function VsucodeburnPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs codeburn — Cost Tracking vs Efficiency Scoring", "codeburn tracks AI coding cost across tools. SigRank scores efficiency. Cost is the input; yield is the output.", "/vs/codeburn"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/codeburn" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and codeburn?", answer: "codeburn tracks AI coding cost across tools. SigRank scores efficiency. Cost is the input; yield is the output. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both codeburn and SigRank?", answer: "Yes. They're complementary. Use codeburn for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs codeburn — Cost Tracking vs Efficiency Scoring</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Cost tracking vs efficiency scoring</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">codeburn</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">AI coding cost across tools</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>codeburn tracks AI coding cost across tools. SigRank scores efficiency. Cost is the input; yield is the output.</p>
        <p>
          ...
          the question codeburn can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and codeburn?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Can I use both codeburn and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop tracking cost. Start measuring yield.</p>
        <a
