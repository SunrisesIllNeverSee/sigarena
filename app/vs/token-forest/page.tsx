...
export const metadata: Metadata = {
  title: "SigRank vs token-forest — Token Counting vs Cascade Scoring",
  description:
    "token-forest counts tokens across sessions. SigRank scores cascades. Counting is not scoring.",
  alternates: { canonical: "/vs/token-forest" },
  openGraph: {
    title: "SigRank vs token-forest — Token Counting vs Cascade Scoring",
    description: "Token forest vs cascade yield",
    url: "https://sigeconomy.com/vs/token-forest",
    type: "website",
  },
};

export default function VsutokenforestPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs token-forest — Token Counting vs Cascade Scoring", "token-forest counts tokens across sessions. SigRank scores cascades. Counting is not scoring.", "/vs/token-forest"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/token-forest" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and token-forest?", answer: "token-forest counts tokens across sessions. SigRank scores cascades. Counting is not scoring. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both token-forest and SigRank?", answer: "Yes. They're complementary. Use token-forest for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs token-forest — Token Counting vs Cascade Scoring</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Token forest vs cascade yield</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">token-forest</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">Token counts across sessions</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">How many tokens you used</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>token-forest counts tokens across sessions. SigRank scores cascades. Counting is not scoring.</p>
        <p>
          ...
          the question token-forest can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and token-forest?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Can I use both token-forest and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop counting trees. Start scoring the forest.</p>
        <a
