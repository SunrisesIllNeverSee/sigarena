...
export const metadata: Metadata = {
  title: "SigRank vs notch-pilot — Copilot vs Pilot Score",
  description:
    "notch-pilot is an AI coding copilot. SigRank scores the pilot, not the plane. The assistant isn't the operator.",
  alternates: { canonical: "/vs/notch-pilot" },
  openGraph: {
    title: "SigRank vs notch-pilot — Copilot vs Pilot Score",
    description: "The copilot vs the pilot score",
    url: "https://sigeconomy.com/vs/notch-pilot",
    type: "website",
  },
};

export default function VsunotchpilotPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs notch-pilot — Copilot vs Pilot Score", "notch-pilot is an AI coding copilot. SigRank scores the pilot, not the plane. The assistant isn't the operator.", "/vs/notch-pilot"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/notch-pilot" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and notch-pilot?", answer: "notch-pilot is an AI coding copilot. SigRank scores the pilot, not the plane. The assistant isn't the operator. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both notch-pilot and SigRank?", answer: "Yes. They're complementary. Use notch-pilot for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs notch-pilot — Copilot vs Pilot Score</span>
        </h1>
        <p className="mt-2 text-muted-foreground">The copilot vs the pilot score</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">notch-pilot</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">AI coding copilot</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">What the copilot did</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>notch-pilot is an AI coding copilot. SigRank scores the pilot, not the plane. The assistant isn't the operator.</p>
        <p>
          ...
          the question notch-pilot can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and notch-pilot?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              notch-pilot is an AI coding copilot. SigRank scores the pilot, not the plane. The assistant isn't the operator. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both notch-pilot and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use notch-pilot for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop measuring the copilot. Start scoring the pilot.</p>
        <a
