...
export const metadata: Metadata = {
  title: "SigRank vs tokenmaxxer — Token Maximizing vs Yield",
  description:
  ...
  alternates: { canonical: "/vs/tokenmaxxer" },
  openGraph: {
    title: "SigRank vs tokenmaxxer — Token Maximizing vs Yield",
    description: "Token maximizing vs cascade yield",
    url: "https://sigeconomy.com/vs/tokenmaxxer",
    type: "website",
  },
};

export default function VsutokenmaxxerPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs tokenmaxxer — Token Maximizing vs Yield", "tokenmaxxer celebrates burning more tokens. SigRank celebrates compounding them. Maximizing tokens is the opposite of efficiency.", "/vs/tokenmaxxer"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/tokenmaxxer" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and tokenmaxxer?", answer: "tokenmaxxer celebrates burning more tokens. SigRank celebrates compounding them. Maximizing tokens is the opposite of efficiency. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both tokenmaxxer and SigRank?", answer: "Yes. They're complementary. Use tokenmaxxer for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs tokenmaxxer — Token Maximizing vs Yield</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Token maximizing vs cascade yield</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">tokenmaxxer</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">Token maximization (burning more)</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">How much you burned</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>tokenmaxxer celebrates burning more tokens. SigRank celebrates compounding them. Maximizing tokens is the opposite of efficiency.</p>
        <p>
          ...
          the question tokenmaxxer can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and tokenmaxxer?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Can I use both tokenmaxxer and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop maxxing. Start compounding.</p>
        <a
