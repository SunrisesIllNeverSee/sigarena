...
export const metadata: Metadata = {
  title: "SigRank vs whoburnedmore — Who Burned More vs Who Yielded More",
  description:
    "whoburnedmore ranks who burned the most tokens. SigRank ranks who yielded the most. Burn rate is participation; yield is skill.",
  alternates: { canonical: "/vs/whoburnedmore" },
  openGraph: {
    title: "SigRank vs whoburnedmore — Who Burned More vs Who Yielded More",
    description: "Burn comparison vs yield comparison",
    url: "https://sigeconomy.com/vs/whoburnedmore",
    type: "website",
  },
};

export default function VsuwhoburnedmorePage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs whoburnedmore — Who Burned More vs Who Yielded More", "whoburnedmore ranks who burned the most tokens. SigRank ranks who yielded the most. Burn rate is participation; yield is skill.", "/vs/whoburnedmore"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/whoburnedmore" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and whoburnedmore?", answer: "whoburnedmore ranks who burned the most tokens. SigRank ranks who yielded the most. Burn rate is participation; yield is skill. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both whoburnedmore and SigRank?", answer: "Yes. They're complementary. Use whoburnedmore for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs whoburnedmore — Who Burned More vs Who Yielded More</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Burn comparison vs yield comparison</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">whoburnedmore</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              <td className="px-4 py-3 font-semibold">What it measures</td>
              <td className="px-4 py-3 text-muted-foreground">Who yielded the most per token</td>
              <td className="px-4 py-3 text-muted-foreground">Who burned the most tokens</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">Who participated the most</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>whoburnedmore ranks who burned the most tokens. SigRank ranks who yielded the most. Burn rate is participation; yield is skill.</p>
        <p>
          ...
          the question whoburnedmore can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and whoburnedmore?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              whoburnedmore ranks who burned the most tokens. SigRank ranks who yielded the most. Burn rate is participation; yield is skill. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both whoburnedmore and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use whoburnedmore for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop comparing burn. Start comparing yield.</p>
        <a
