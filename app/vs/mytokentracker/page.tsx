    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and mytokentracker?</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground">Does SigRank compete with mytokentracker?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
