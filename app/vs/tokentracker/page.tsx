    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and Token Tracker?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Token Tracker monitors token volume across 29 tools with desktop widgets. SigRank measures token-cascade efficiency with Yield. Tracking tells a developer how much they burned; Yield tells them how well. One monitors volume; the other measures skill.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Does SigRank compete with Token Tracker?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              No {"\u2014"} they serve different needs. Token Tracker gives an always-on view of token volume across many tools. SigRank ranks AI operators by efficiency. A person using AI can track volume with Token Tracker and measure skill with SigRank.
            </p>
          </div>
          <div>
