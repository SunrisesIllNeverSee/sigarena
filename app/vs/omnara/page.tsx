...
export const metadata: Metadata = {
  title: "SigRank vs omnara — Usage Dashboard vs Yield Leaderboard",
  description:
    "omnara is an AI usage dashboard. SigRank is a yield leaderboard. A dashboard shows you numbers; a leaderboard shows you where you rank.",
  alternates: { canonical: "/vs/omnara" },
  openGraph: {
    title: "SigRank vs omnara — Usage Dashboard vs Yield Leaderboard",
    description: "Usage dashboard vs yield leaderboard",
    url: "https://sigeconomy.com/vs/omnara",
    type: "website",
  },
};

export default function VsuomnaraPage() {
  return (
    <div className="space-y-6">
      <JsonLd data={[
        articleSchema("SigRank vs omnara — Usage Dashboard vs Yield Leaderboard", "omnara is an AI usage dashboard. SigRank is a yield leaderboard. A dashboard shows you numbers; a leaderboard shows you where you rank.", "/vs/omnara"),
        breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Compare", path: "/vs/omnara" },
        ]),
        faqSchema([
          { question: "What is the difference between SigRank and omnara?", answer: "omnara is an AI usage dashboard. SigRank is a yield leaderboard. A dashboard shows you numbers; a leaderboard shows you where you rank. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency — whether your tokens are compounding signal or burning." },
          { question: "Can I use both omnara and SigRank?", answer: "Yes. They're complementary. Use omnara for its function, and run sigrank submit to publish your cascade score to the leaderboard. The same local logs feed both." },
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="gradient-text">SigRank vs omnara — Usage Dashboard vs Yield Leaderboard</span>
        </h1>
        <p className="mt-2 text-muted-foreground">Usage dashboard vs yield leaderboard</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <th className="px-4 py-3 text-left font-medium">omnara</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              <td className="px-4 py-3 font-semibold">What it measures</td>
              <td className="px-4 py-3 text-muted-foreground">Yield leaderboard + class tiers</td>
              <td className="px-4 py-3 text-muted-foreground">AI usage dashboard</td>
            </tr>
            <tr className="border-b border-border">
              ...
              <td className="px-4 py-3 text-muted-foreground">What your usage looks like</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6 text-sm text-muted-foreground">
        ...
        <p>omnara is an AI usage dashboard. SigRank is a yield leaderboard. A dashboard shows you numbers; a leaderboard shows you where you rank.</p>
        <p>
          ...
          the question omnara can&apos;t answer.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-foreground">What is the difference between SigRank and omnara?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              omnara is an AI usage dashboard. SigRank is a yield leaderboard. A dashboard shows you numbers; a leaderboard shows you where you rank. SigRank's Yield (Υ) = (cache_read × output) / input² measures cascade efficiency.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">Can I use both omnara and SigRank?</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              Yes. They're complementary. Use omnara for its function, and run sigrank submit to publish your cascade score to the leaderboard.
            </p>
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-primary/20 gradient-primary p-8 text-center text-white glow-primary">
        <p className="text-xl font-bold">Stop dashboarding. Start ranking.</p>
        <a
