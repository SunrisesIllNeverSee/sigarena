...
export const PROMPTS: Prompt[] = [
  {
    ...
    seo_keywords: ["best ai user", "ai user leaderboard", "who is the best at using ai", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    seo_keywords: ["output per token", "ai productivity", "token productivity", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    is_existing_route: false,
    seo_keywords: ["ai context reuse", "cache reuse ai", "context management", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    is_existing_route: false,
    seo_keywords: ["signal to noise ai", "ai signal quality", "clean signal", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    is_existing_route: false,
    seo_keywords: ["ai leverage", "cache leverage", "normalized leverage", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    is_existing_route: false,
    seo_keywords: ["ai efficiency", "most efficient ai user", "token efficiency", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    slug: "largest-scale",
    is_existing_route: false,
    seo_keywords: ["ai scale", "largest ai user", "token volume", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    is_existing_route: false,
    seo_keywords: ["cheapest ai tokens", "token cost", "ai cost efficiency", "operator evals", "public operator evals"],
  ...
  },
  {
    ...
    slug: "best-op-ratio",
    is_existing_route: false,
    seo_keywords: ["operating ratio ai", "cache input output ratio", "operator evals", "public operator evals"],
